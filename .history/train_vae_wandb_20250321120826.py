...
if __name__ == "__main__":
    ...
    #archive = np.load("datasets\\01-02-2024-random_17_10k.npy") # random
    ...
    sweep_config = {
    'method': 'grid',
    'name': '31-12-2024-rq3-ads_tanh-2',#'29-01-2024-non-random-ads_tanh_-1_1',
    'metric': {
        'goal': 'minimize', 
        'name': 'validation_loss'
        },
    'parameters': {
         'model': {'values': ["DeepVecVAE"]}, #"VecVAESimple", "VecVAE",
        'loss_func': {'values': ["lossA"]} ,#, "lossB"
        'batch_size': {'values': [512]},
        'lr': {'values': [0.001]},
         "nlat": {'values': [20, 22, 25]}, #[17,  16, 15, 14, 12, 10, 8]
        'name': {'values': ['31-12-2024-rq3-ads_tanh-2']}
     }
    }
