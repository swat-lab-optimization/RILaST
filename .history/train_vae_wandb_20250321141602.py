...
def sweep_train(config=None):
    ...
    with wandb.init(entity="dmhum",  config=config):
        ...
        nDim = config['ndim'] # # 20#Dimension of the input vector for VAE
        nLat = config["nlat"]# #20#

        models = {"VAE1": VAE['VAE1'](nDim, nLat), "VAE2": VAE['VAE2'](nDim, nLat), "VAE3": VAE['VAE3'](nDim, nLat) }
