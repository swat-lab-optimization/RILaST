...
## Framework overview
One of the main components you should define in the context of Rilast is a ```TestGenerator``` class. This class should implement the ```initialize_problem``` method, that 
